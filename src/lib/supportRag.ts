...
export async function generateSupportRagAnswer(
  ...
  if (isExplicitAdminRequest) {
    return {
      ...
      suggestions: ['🚚 Track My Order', '📚 Browse 10th Guides', '📞 Call Office (+91 94860 17820)'],
      shouldEscalate: true,
      cardType: 'contact',
    };
  }
    ...
    if (orderRow) {
      ...
      if (customerId && orderRow.user_id && String(orderRow.user_id) !== String(customerId) && !isPhoneMatch) {
        return {
          ...
          suggestions: ['🚚 Track My Own Order', '👨‍💼 Talk to Admin', '📞 Call Helpline (+91 94860 17820)'],
          shouldEscalate: false,
        };
      }
  ...
  if (
    ...
    return {
      answer: `🛡️ **100% Free Replacement Guarantee**:\n\n${STORE_POLICIES.returnPolicy}\n\nIf your parcel arrived damaged in transit or has any printing defect, please click **Connect to Admin Now** below or send a photo of the parcel/book to our WhatsApp helpline at **+91 94860 17820**. Our Chennai dispatch office will send a fresh copy immediately.`,
      suggestions: ['👨‍💼 Talk to Admin', '📞 Call Helpline (+91 94860 17820)', '💬 WhatsApp Support', '🚚 Track Order'],
      shouldEscalate: false,
      cardType: 'contact',
    };
  }
  ...
  if (
    ...
    return {
      ...
      suggestions: ['👨‍💼 Talk to Admin', '📞 Call Office Directly (+91 94860 17820)', '💬 WhatsApp Helpline', '🚚 Track Order'],
      shouldEscalate: false,
      cardType: 'contact',
    };
  }
  ...
  if (
    ...
    return {
      ...
      suggestions: ['👨‍💼 Talk to Admin', '📞 Call Office (+91 94860 17820)', '💬 WhatsApp Admin'],
      shouldEscalate: false,
    };
  }
  ...
  if (
    ...
    return {
      ...
      suggestions: ['🚚 Track Order', '👨‍💼 Request GST Invoice from Admin', '📞 Call Office (+91 94860 17820)'],
      shouldEscalate: false,
    };
  }
