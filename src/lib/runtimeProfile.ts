  ...
  switch (t) {
    case 'free':
      return {
        ...
        load: 'normal',
        dbPoolMax: 1,
        dbHeartbeatMs: 120_000,
        dbConnectTimeoutMs: 45_000,
        courierCronEnabled: true,
        courierCronIntervalMs: 15 * 60 * 1000,
        courierCronStartDelayMs: 90_000,
        leaderElectionIntervalMs: 45_000,
        whatsappOutboxIntervalMs: 8000,
        orderListenEnabled: true,
        orderListenPingMs: 90_000,
      };
    case 'hobby':
      return {
        tier: t,
