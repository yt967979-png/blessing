      ...
      <div className="flex flex-wrap items-center justify-between gap-3 bg-white border border-slate-200 rounded-2xl p-4 sm:p-5 shadow-xs">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span className="hidden sm:inline">+91 94860 17820</span>
            <span className="sm:hidden">Call</span>
          </a>
          <a
            href="https://wa.me/919486017820?text=Hello%20Blessing%20Power%20Guide%20Support,%20I%20need%20help%20with%20an%20order"
            target="_blank"
