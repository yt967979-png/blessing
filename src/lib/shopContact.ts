...
export const DEFAULT_CUSTOMER_SUPPORT_PHONE = '+91 63829 63350';
export const SECONDARY_CONTACT_PHONE = '+91 94860 17820';

function digitsOnly(raw: string) {
  return String(raw || '').replace(/\D/g, '');
}

/** E.164-ish digits for wa.me (91XXXXXXXXXX) — defaults to customer support 6382963350. */
...
/** Display form e.g. +91 63829 63350 */
...
/** Secondary display form e.g. +91 94860 17820 */
